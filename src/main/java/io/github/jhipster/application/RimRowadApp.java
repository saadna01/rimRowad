...
public class RimRowadApp {

    private static final Logger log = LoggerFactory.getLogger(RimRowadApp.class);

    private final Environment env;

    public RimRowadApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes rimRowad.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RimRowadApp.class);
